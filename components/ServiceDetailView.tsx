              ...
              <ScrollReveal key={other.slug} delay={index * 0.08}>
                ...
                >
                  <div
                    ...
                    style={{ backgroundImage: `url(${getServiceImage(other.slug, other.listingImage, other.detail.heroImage, 'listing')})` }}
                  />
